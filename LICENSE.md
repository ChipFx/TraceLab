...
## TraceLab Software License (Apache 2.0 with Attribution Addendum)
...
1. **Attribution Required**  
   ...
   clear attribution to the original author(s) and the ChipFX TraceLab project.
...
4. **No Trademark Grant**  
   This license does not grant permission to use the "ChipFX" or "TraceLab"
